...
from application.dto.user_dto import UserCreateDTO, UserLoginDTO, TokenResponseDTO
...
class AuthUseCases:
    ...
    async def register_user(self, user_data: UserCreateDTO) -> Dict[str, Any]:
        ...
        # Generate tokens
        access_token = self.jwt_service.create_access_token(created_user.id, created_user.username)
