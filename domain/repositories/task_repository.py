...
class TaskRepository(ABC):
    ...
    @abstractmethod
    async def get_by_user_id(self, user_id: UserId, limit: int = 100, offset: int = 0) -> List[Task]:
    ...
    @abstractmethod
    async def get_completed_by_user_id(self, user_id: UserId, limit: int = 100, offset: int = 0) -> List[Task]:
        """Get completed tasks for a specific user"""
        pass
    
    @abstractmethod
    async def get_pending_by_user_id(self, user_id: UserId, limit: int = 100, offset: int = 0) -> List[Task]:
